...
def _source_map_from_confidences(
    ...
    """Create mapping of page number to OCR source (docling or sarvam).
    ...
    page_confidences : Dict[int, Optional[float]]
        Mapping of page number to confidence score
    low_pages : List[int]
        List of page numbers with low confidence
        
    Returns
    -------
    Dict[int, str]
        Mapping of page number to source ("docling" or "sarvam")
    """
